...
Greet achievement, did my first YouTube video, not much really, but it means I can actually do more and hopefully improve on quality.

With Slides over, it's time to go back to finalizing "Essentials of Data Analysis and Graphics using R", specifically start working on chapter three "Exploratory Data Analysis (EDA)". Can't give exact time for release but anticipate it to be in two weeks from start. I should have a good idea by Friday.
