...
Happy Easter Saturday, it's a beautiful day to do some bit of works, woun't you agree?

I have decided to pause EDA  as it has become clear it would not be possible to discuss using EDA for model building without knowledge of some basic models. Since most of the models are discussed in later chapters begining with inferential, then it's prudent to discuss these first.
