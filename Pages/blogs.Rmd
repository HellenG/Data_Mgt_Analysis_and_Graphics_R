...
In deed, I am super excited to say appendix 1 on refresher mathematics is done. Well at least zero draft which core part of writing process. What is left now is to make it draft 1 which would be ready for uploading. I am currently working on this and should be done by Monday if all things remain constant. I am sure I will be uploading this chapter as I make this blog live, so check it out. 
