...
# Introduction to Version Control Systems{#chap3}
...
## Introduction: What and Why Version Control System{#whatvcsis}
...
![Git configuration](figures/gitConfigList.PNG)
...
Do take note of the line right above input symbol "$", there should be a <b>(master)</b> written after our repository name, something like this <em>user@Hellen MINGW32 ~ Documents/learningGit(master)</em>. It is important to always be aware of this line as it tells us which repository we are working on and if it is the main repository or a branch of it. We will be discussing [branching](#branching) a bit later, but at this point it good to start knowing where you are; <b>master</b> means it's our main repository. We will meet other branches like origin and remote later.
...
![Clean Git repo](figures/gitNoFilesToTrack.PNG)
...
As an example I will tell Git to start tracking some of my R scripts so I will change working directory to this folder and initialize Git. It is good to know how to specify file locations, you can read [this](#files) notes on files.
...
![Git repo with untracked files](figures/gitUntrackedFiles.PNG)
...
![Git address](figures/gitLearningGitMaster.PNG)
...
![One untracked file](figures/gitOneUntrackedFile.PNG)
...
![Tracking a file](figures/gitTrackedFile.PNG)
...
![Git status after stagging a file](figures/gitStatusAfterTracking.PNG)
...
![Git status after change to a staged file](figures/gitStatusAfterChange.PNG)
...
![Git status when a .docx file is created](figures/gitNewWordDoc.PNG)
...
![A .gitignore file](figures/gitDotIgnoreFile.PNG)
...
![Git status when .docx is added to .gitinore](figures/gitNewDotGitIgnore.PNG)
...
![Git commit log](figures/gitLog1.PNG)
...
![Git branches](figures/gitNewBranch.PNG)
...
![Git status on new branch](figures/gitCommitToBranch.PNG)
...
![Git status on master branch](figures/gitRevertToMaster1.PNG)   
...
![Git commits to second branch](figures/gitCommitToBranch2.PNG)
...
![Git commit progress](figures/gitCommitProgress1.PNG)
...
![Git merge](figures/gitMerge1.PNG)
...
![Git commit to a branch](figures/gitCommitToBranch3.PNG)
...
![Git commit progress](figures/gitCommitProgress2.PNG)
...
![Git second merge](figures/gitMerge2.PNG)
...
![Creating a new repo on GitHub](figures/gitHubNew.PNG)
...
!["learningGit" repo on GitHub](figures/gitHubLearningGitRepo.PNG)
...
![GitHub README commit](figures/gitHubREADMECommit.PNG)
...
![Git pull with unrelated histories](figures/gitHubPullRemote.PNG)
...
![Push to upstream](figures/gitHubPushToRemote.PNG)
...
![Forking a public repo](figures/gitHubFolked.PNG)
...
![Version Control on RStudio](figures/gitRStudioVC.PNG)
...
![RStudio's pane showing version control](figures/gitRstudioNewFile.PNG)
...
![Staging and Commiting on RStudio](figures/gitRStudioAddCommit.PNG)
...
![Push progress on RStudio](figures/gitRStudioPushProgressBar.PNG)

![Notification of Pushed commits](figures/gitRStudioPushed.PNG)
...
1. Pro GIT - chapter's Reference Book on matters Git and GitHub: *https://progit2.s3.amazonaws.com/en/2016-01-30-9e7cf/progit-en.1005.pdf) (main reference point)*
